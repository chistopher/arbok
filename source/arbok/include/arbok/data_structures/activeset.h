...
public:
    ...
    virtual void meld(std::vector<AbstractActiveSet>& active_sets) = 0;
...
public:
    ...
    virtual void meld(std::vector<AbstractActiveSet>& active_sets);
...
private:
    virtual void _move_and_modify_key(NodeType node, AbstractActiveSet& target_set, KeyType new_key);
